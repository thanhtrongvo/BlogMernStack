                ...
                <>
                  <div className="flex items-center justify-center space-x-3 bg-gray-50 p-4 rounded-lg">
                    <img
                      ...
                      alt={user.username}
                      className="w-10 h-10 rounded-full border border-gray-200 ring-2 ring-primary/20"
                    />
                    <div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="focus:outline-none hover:opacity-80 transition-opacity">
                <img
                  src="https://secure.gravatar.com/avatar/9be0621ecc601641f92b127feaf5f3ba6119d27f5e16ec987d1beeb8174c35dd?s=70&d=mm&r=g"
                  alt={user.username}
                  className="w-9 h-9 rounded-full border border-gray-200 ring-2 ring-primary/20"
                />
              </DropdownMenuTrigger>
              <DropdownMenuContent
                align="end"
                className="w-56 p-2 rounded-lg shadow-lg border-gray-200"
              >
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem
                  className="cursor-pointer rounded-md transition-colors hover:bg-gray-100"
                  asChild
                >
                  <Link to="/profile">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem
                  className="cursor-pointer rounded-md transition-colors hover:bg-red-50 text-red-600 hover:text-red-700"
